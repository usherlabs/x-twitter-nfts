...
near contract deploy $NEAR_VERIFIER_CONTRACT_ACCOUNT use-file target/near_x_twitter_nfts.wasm with-init-call init json-args '{"contract_address":"'$EVM_VERIFIER_ADDRESS'", "aurora":"aurora","nft_account_id":"'$NEAR_NFT_CONTRACT'"}' prepaid-gas '200.0 Tgas' attached-deposit '0 NEAR' network-config testnet sign-with-keychain send